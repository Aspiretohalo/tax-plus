<template>
  <div class="box">
    <el-button @click="handleClick">我是学生</el-button>
    <h3>教师端</h3>
    <el-form class="el-form" label-position="top" :model="teacher" label-width="120px" :rules="rules" ref="ruleFormRef"
      ...
      <el-form-item class="el-form-item">
        <el-button type="primary" @click="submitFormTeacher(ruleFormRef)" size="large">登录</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
